...
In order to make inferences via our HMM model we would need to obtain the joint probability distribution of mortality and the regimes through the observed time period.   
\[P(Y_{1:(T-1)},k_{1:(T-1)})
\label{eq:likelihood}
\]
