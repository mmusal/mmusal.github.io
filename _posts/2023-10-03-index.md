...
knit: (function(inputFile, encoding) {
  ...
  encoding = encoding, 
  output_file=paste0(Sys.Date(), "-", sub(".Rmd", ".md",inputFile)),   output_dir = "C:/Users/rm84/Documents/GitHub/mmusal.github.io/_posts") })
layout: post
...
![](/assets/img/index/unnamed-chunk-2-1.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-2-2.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-4-1.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-4-2.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-4-3.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-5-1.png)<!-- -->
...
![](/assets/img/index/unnamed-chunk-6-1.png)<!-- -->
