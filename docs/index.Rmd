...
```{r}
CASummary=read.table(header=TRUE,sep=',','C:/Users/rm84/Documents/CASummary.csv')
#Each of the 58 counties of California in alphabetical and FIPS order have 164 columns of information associated with it.
dim(names)

names(CASummary)

#We use a merge statement that will perform a 1 to 1 match
